...
class Buttons extends React.Component {
  render () {
    ...
    <div className="buttons-container">
        <button className="not-numbers" id="clear" value='AC' onClick={this.props.initialize}>C</button>
        <button className="not-numbers" id="erase" value="erase" onClick={this.props.handleErase}><i class="fas fa-backspace"></i></button>
        <button className="not-numbers" id="multiply" value='*' onClick={this.props.handleOperators}>x</button>
        <button className="not-numbers" id="divide" value='/' onClick={this.props.handleOperators}>/</button>
        ...
        <button className="not-numbers" id="add" value='+' onClick={this.props.handleOperators}>+</button>
        ...
        <button className="not-numbers" id="subtract" value='-' onClick={this.props.handleOperators}>-</button>
        ...
        <button className="not-numbers" id="equals" onClick={this.props.result}>=</button>
